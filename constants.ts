...
export const initialClassData: ClassDataMap = {
  ...
  "CIEP320_AP301": { 
    ...
    school: "CIEP 320",
    students: [
      { id: 30101, name: "Ana Karollina Silva Ávila", attendance: { "15/05": "Atraso" } },
      ...
      { id: 30107, name: "Kaylanne Ribeiro Canuto", attendance: { "15/05": "Atraso" } },
      { id: 30108, name: "Leonardo Kauã Oliveira de Paiva", attendance: { "15/05": "Atraso" } },
      ...
      { id: 30113, name: "Rodrigo Rafael Silva de Oliveira", attendance: { "15/05": "Atraso" } },
