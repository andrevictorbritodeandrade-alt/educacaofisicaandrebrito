  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <button 
          onClick={onBack}
          className="self-start px-5 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-lg border border-white/20 text-white rounded-xl font-bold transition-all shadow-md flex items-center gap-2 active:scale-95"
        >
      ...
      <div className="bg-slate-900/80 backdrop-blur-3xl p-6 md:p-10 rounded-[3rem] border border-white/10 text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Avalia RJ', color: 'bg-red-900', icon: 'AVALIA RJ' },
